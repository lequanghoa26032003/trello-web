    ...
    <Box px={2} sx={{
      ...
      <Box sx= {{ display: 'flex', alignItems: 'center', gap:2 }} >
        ...
        <Box sx= {{ display: 'flex', alignItems: 'center', gap:1 }}>
          <SvgIcon component={StarIcon} inheritViewBox fontSize="small" sx= { { color: 'primary.main' } } />
      ...
      <Box sx= {{ display: 'flex', alignItems: 'center', gap:2 }} >
        ...
        <Tooltip title="Notifications" placement="top">
          <Badge badgeContent={4} color="error">
            <NotificationsNoneIcon color="action" sx={{ cursor: 'pointer', color: 'primary.main' }} />
          </Badge>
        </Tooltip>
        <Tooltip title="Help" placement="top">
          <HelpOutlineIcon color="action" sx={{ cursor: 'pointer', color: 'primary.main' }} />
        </Tooltip>
        <Profile />
      </Box>
    </Box>
